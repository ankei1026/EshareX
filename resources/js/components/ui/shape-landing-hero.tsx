...
function HeroGeometric({
    badge = "EshareX",
    title1 = "Share. Learn. Grow.",
    title2 = "Crafting Exceptional Messages",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            <span className="text-3xl sm:text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                                {title1}
                            </span>
                            <br />
                            <span
